...
class TestView(TestCase):
    ...
    def category_card_test(self, soup):
        ...
        self.assertIn(f'{self.category_programming.name} '
                      f'({self.category_programming.post_set.count()})', categories_card.text)
        self.assertIn(f'{self.category_music.name} '
                      f'({self.category_music.post_set.count()})', categories_card.text)
    ...
    def test_update_post(self):
        ...
        tag_str_input = main_area.find('input', id='id_tags_str')
        self.assertTrue(tag_str_input)
        #print(type(tag_str_input.attrs))
    ...
    def test_comment_form(self):
        ...
        comment_area = soup.find('div', id='comments-area')
        ...
        #print(comment_form)
        #self.assertTrue(comment_form.find('textarea', id='id-content'))
        response = self.client.post(
    ...
    def test_comment_update(self):
        ...
        update_coment_form = soup.find('form', id='comment-form')
        content_textarea = update_coment_form.find('textarea', id='id_content')
